...
namespace digiturno.Data.VistaTurnos
{
    public class VistaTurnos
    {
        ...
        public VistaTurnos(int p_idturno,int? p_idsucursal,int? p_idservicio,string p_turno,string p_cedular,string p_servicio,string p_sucursal,bool p_esllamado,bool p_nosepresento,bool p_atendido,int? p_idmodulo,string p_modulo) { 
            Idturno= p_idturno;
